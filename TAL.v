...
| S_JmpR :  forall Psi Gamma v i,  Gamma (Id i) = Some True -> update Gamma (Id i) True = Gamma -> ahas_type Psi Gamma (AReg v) True -> ihas_type Psi Gamma (IJmp (AReg v)) (code Gamma)
